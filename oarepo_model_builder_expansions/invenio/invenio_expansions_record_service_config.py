...
class InvenioExpansionsRecordServiceConfigBuilder(InvenioBaseClassPythonBuilder):
    TYPE = "invenio_expansions_record_service_config"
    class_config = "record-service-config-class"
    template = "expansions-record-service-config"
